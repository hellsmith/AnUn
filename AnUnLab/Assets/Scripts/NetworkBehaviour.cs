...
public class NetworkBehaviour : MonoBehaviour {
	...
	private string 	titleMessage = "AnUu";
	private string 	connectToIP = "127.0.0.1";
	private int 	connectionPort = 25000;
	...
	//-----------------------------------------------------
	//-- These variables are used to define the server shutdown 
	//-----------------------------------------------------
	...
	{
		GameObject newShip = Network.Instantiate(playerShip,new Vector3(0f,0f,0f),Quaternion.identity,0) as GameObject;
		newShip.GetComponent<ShipBean> ().ShipName = playerName;
		this.GetComponent<GameControll> ().SelectedShip = newShip;
	}
